...
# install survives the /data volume overlay at runtime.
...
ENTRYPOINT [ "/usr/bin/tini", "-g", "--", "/opt/hermes/docker/entrypoint.sh", "dashboard", "--host 0.0.0.0", "--no-open", "--insecure" ]
